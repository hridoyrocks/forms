            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                @enderror
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" name="submit_button_text" id="submit_button_text" value="{{ old('submit_button_text', 'Submit') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                        </div>
                        
                        <div class="mb-6">
                            <label for="success_message" class="block text-sm font-medium text-gray-700">Success Message</label>
                            <input type="text" name="success_message" id="success_message" value="{{ old('success_message', 'Form submitted successfully!') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                        </div>
                        
                        <div class="flex items-center justify-end mt-6">
                            <a href="{{ route('forms.index') }}" class="text-sm text-gray-700 underline mr-4">Cancel</a>
        ...
        <div class="field-item bg-gray-50 p-4 rounded-md mb-4">
            <div class="flex justify-between items-start mb-4">
                ...
                <div class="w-1/4 pl-2 flex items-end">
                    <label class="inline-flex items-center mt-1">
                        <input type="checkbox" name="fields[INDEX][required]" value="1" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
            ...
            <div class="options-container hidden">
                <div class="mt-2">
                    ...
                    <textarea name="fields[INDEX][options]" rows="3" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"></textarea>
                </div>
            </div>
        </div>
    </template>
